...
# マッチングに使うソース画像のパス
sourceImagePath = "https://www.pakutaso.com/shared/img/thumb/ME_biz20160902550815_TP_V.jpg"
...
listOfFacialRecognitionConnector = [FacePlusFacialRecognitionConnector.FacePlusFacialRecognitionConnector,
                                    ...
                                    OpenCVFacialRecognitionConnector.OpenCVFacialRecognitionConnector]

# ファイルオープン
f = open('face_API_comparison.csv', 'w')
...
for connector in listOfFacialRecognitionConnector:
    try:
        ...
        for k, v in face_dict.items():
            comparison = str(ins.compareFace(sourceImagePath, v))
            dataList.append(comparison)
            print(k+":"+comparison)
        # CSV出力
